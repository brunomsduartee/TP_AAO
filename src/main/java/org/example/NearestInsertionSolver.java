...
public class NearestInsertionSolver implements AllocationStrategy {
    @Override
    public void solve(ProblemInstance problemInstance) {
        ...
        System.out.println("Nearest Insertion Total cost: " + totalCost);
        System.out.println("Opened facilities by Nearest Insertion:");
